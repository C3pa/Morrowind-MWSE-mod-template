local configFile = "Localized Template"

---@class templateLocalized.configTable
local default = {
...
local this = {
	version = "0.1.0",
	---@type templateLocalized.configTable
	config = {},
	default = default,
}
...
---@return templateLocalized.configTable
...
--- Usually used in mcm\init.lua
--- @param mcmConfig templateLocalized.configTable
